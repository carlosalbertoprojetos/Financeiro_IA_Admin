...
echo ========================================
echo   TIP - Executive Operation Report
echo ========================================
echo.
...
start "EOR Backend" cmd /k "cd /d "%CD%" && .venv\Scripts\python.exe manage.py runserver %BACKEND_PORT%"
...
start "EOR Frontend" cmd /k "cd /d "%CD%\frontend" && npm run dev:3000"
...
set /a ATTEMPTS+=1
if %ATTEMPTS% GTR 30 (
    echo       AVISO: Timeout. Verifique a janela "EOR Frontend" por erros.
    goto OPEN_BROWSER
)
