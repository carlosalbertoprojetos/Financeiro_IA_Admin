...
@registry.register
class ClickUpAdapter(BaseIntegrationAdapter):
    """ClickUp provider — placeholder for Future MVP."""

    provider = "clickup"

    def authenticate(self, connection: IntegrationConnection) -> None:
        raise ProviderNotReadyError("ClickUp integration is not yet implemented.")
